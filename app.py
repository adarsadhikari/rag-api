...
from pincone_utils import index_document_to_pc, delete_doc_from_pc
import os
import logging
import shutil
import uuid
...
def upload_and_index_document(file: UploadFile = File(...)):
    ...
    try:
        ...
        success = index_document_to_pc(temp_file_path, file_id)
...
def delete_document(request: DeleteFileRequest):
    pinecone_delete_success = delete_doc_from_pc(request.file_id)
